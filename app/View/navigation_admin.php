    ...
    <aside id="sidebar" class="js-sidebar">
        ...
        <div class="h-100">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="#" class="sidebar-link collapsed" data-bs-target="#admin" data-bs-toggle="collapse" aria-expanded="false"><i class="fa-regular fa-user pe-2"></i>
                        Admin
                    </a>
                    <ul id="admin" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="/users/kelola-user" class="sidebar-link"><i class="fa-solid fa-gear px-2"></i>Kelola User</a>
                        </li>
                    </ul>
                </li>
            </ul>
